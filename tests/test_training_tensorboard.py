...
def test_scalar_logger_writes_readable_required_tags(tmp_path: Path) -> None:
    ...
    logger.log_scalars(
        {
            ...
            "val/camera_fov": 0.2,
            "val/depth": 0.6,
            "val/depth_provided": 0.5,
            "val/depth_unprovided": 0.7,
            "val/provided_frame_count": 2.0,
            "val/unprovided_frame_count": 2.0,
    ...
    assert tags == {
        ...
        "val/depth",
        "val/depth_provided",
        "val/depth_unprovided",
        "val/provided_frame_count",
        "val/unprovided_frame_count",
